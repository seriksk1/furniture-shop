...
export const SendMessageIcon: React.FC<Props> = ({ className }) => {
  return (
    <svg
      className={className}
      fill="#000000"
    ...
    >
      <g>
        <g>
          <path
            d="M471.197,70.93c-0.284-0.378-0.474-0.757-0.756-1.039c-2.648-3.215-6.996-4.255-10.778-2.741L6.088,239.77
